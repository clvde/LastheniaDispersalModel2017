...
filepathspec = "/Users/Courtney/Documents/Rotation 3 - Melbourne & Flaxman Labs/Simulation Results/No Change Extension 1/"
...
c_p <- read.csv(paste(filepathspec,"NoChange_Extension_Gen9300.csv",sep=""))
...
for (t in c(9301:t_max)){
	...
	if (t%%10 == 0){
		...
		write_name <- paste(filepathspec, "NoChange_Extension1_Gen", t, ".csv", sep="")
